    ...
    <div className="relative overflow-hidden bg-white/[0.04] border border-white/10 rounded-[36px] p-7 backdrop-blur-xl hover:border-yellow-500/20 transition-all duration-300">
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center justify-between mb-10">
          ...
          <div className="w-12 h-12 rounded-2xl bg-yellow-500/10 text-yellow-400 flex items-center justify-center shadow-[0_0_25px_rgba(250,204,21,0.12)]">
        ...
        <div className="space-y-5">
          ...
          {insights.map(
            (item, index) => (
              ...
              <div
                key={index}
                className="flex items-start gap-4 p-4 rounded-2xl bg-white/[0.03] border border-white/5 hover:border-yellow-500/10 transition-all duration-300"
              >
